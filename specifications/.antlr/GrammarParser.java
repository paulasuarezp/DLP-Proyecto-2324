...
public class GrammarParser extends Parser {
	...
	public static final int
		...
		T__52=53, T__53=54, T__54=55, T__55=56, T__56=57, INT_CONSTANT=58, REAL_CONSTANT=59, 
		IDENT=60, LINE_COMMENT=61, MULTILINE_COMMENT=62, CHAR_CONSTANT=63, WHITESPACE=64;
	public static final int
		...
		RULE_param = 8, RULE_runCall = 9, RULE_sentence = 10, RULE_switchCase = 11, 
		RULE_initFromLoop = 12, RULE_expr = 13, RULE_type = 14;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "defTuple", "field", "vars", "varListDefinition", "varListIdents", 
			"featureBuilder", "featureDef", "param", "runCall", "sentence", "switchCase", 
			"initFromLoop", "expr", "type"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"REAL_CONSTANT", "IDENT", "LINE_COMMENT", "MULTILINE_COMMENT", "CHAR_CONSTANT", 
			"WHITESPACE"
		};
	}
	...
	public final FeatureDefContext featureDef() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & -7205752255108603904L) != 0)) {
				{
				{
				setState(140);
	...
	public final RunCallContext runCall() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & -7205752256967204864L) != 0)) {
				{
				setState(157);
	...
	public static class SentenceContext extends ParserRuleContext {
		...
		public List<SwitchCaseContext> cases = new ArrayList<SwitchCaseContext>();
		public List<SentenceContext> d = new ArrayList<SentenceContext>();
		public List<ExprContext> expr() {
			return getRuleContexts(ExprContext.class);
		}
		public ExprContext expr(int i) {
	...
	public final SentenceContext sentence() throws RecognitionException {
		...
		try {
			...
			case 8:
				...
				match(T__29);
				setState(262);
				((SentenceContext)_localctx).cond = expr(0);
				setState(263);
				match(T__30);
				setState(267);
				_errHandler.sync(this);
				...
				while (_la==T__34) {
					...
					{
					setState(264);
					((SentenceContext)_localctx).switchCase = switchCase();
					((SentenceContext)_localctx).cases.add(((SentenceContext)_localctx).switchCase);
					}
					}
					setState(269);
					_errHandler.sync(this);
				...
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & -7205752255108603904L) != 0)) {
					...
					setState(271);
					((SentenceContext)_localctx).sentence = sentence();
					((SentenceContext)_localctx).d.add(((SentenceContext)_localctx).sentence);
					}
					}
					setState(276);
					_errHandler.sync(this);
				...
				setState(278);
				match(T__33);
				 ((SentenceContext)_localctx).ast =  new Switch(((SentenceContext)_localctx).cond.ast, ((SentenceContext)_localctx).cases, ((SentenceContext)_localctx).d); 
				}
				break;
			}
		}
	...
	public static class SwitchCaseContext extends ParserRuleContext {
		...
		public ExprContext expr;
		public SentenceContext sentence;
		public List<SentenceContext> b = new ArrayList<SentenceContext>();
		public ExprContext expr() {
	...
	public final SwitchCaseContext switchCase() throws RecognitionException {
		...
		try {
			...
			match(T__34);
			setState(284);
			((SwitchCaseContext)_localctx).expr = expr(0);
			setState(285);
			match(T__9);
			setState(289);
			_errHandler.sync(this);
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & -7205752255108603904L) != 0)) {
				...
				{
				setState(286);
				((SwitchCaseContext)_localctx).sentence = sentence();
				((SwitchCaseContext)_localctx).b.add(((SwitchCaseContext)_localctx).sentence);
				}
				}
				setState(291);
				_errHandler.sync(this);
			...
			setState(292);
			match(T__32);
			 ((SwitchCaseContext)_localctx).ast =  new SwitchCase(((SwitchCaseContext)_localctx).expr.ast, ((SwitchCaseContext)_localctx).b); 
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final InitFromLoopContext initFromLoop() throws RecognitionException {
		...
		enterRule(_localctx, 24, RULE_initFromLoop);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & -7205752256967204864L) != 0)) {
				{
				{
				setState(295);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 5:
						...
						setState(372);
						((ExprContext)_localctx).operator = match(T__52);
						setState(373);
					...
					case 6:
						...
						setState(377);
						((ExprContext)_localctx).operator = match(T__53);
						setState(378);
	...
	public final TypeContext type() throws RecognitionException {
		...
		try {
			...
			case T__54:
				...
				{
				setState(396);
				((TypeContext)_localctx).token = match(T__54);
			...
			case T__55:
				...
				{
				setState(398);
				((TypeContext)_localctx).token = match(T__55);
			...
			case T__56:
				...
				{
				setState(400);
				((TypeContext)_localctx).token = match(T__56);
	...
	public static final String _serializedATN =
		...
		"\u000b\n\u000b\f\u000b\u0123\t\u000b\u0001\u000b\u0001\u000b\u0001\u000b"+
		"\u0001\f\u0001\f\u0001\f\u0001\f\u0001\f\u0001\f\u0005\f\u012e\b\f\n\f"+
		"\f\f\u0131\t\f\u0001\r\u0001\r\u0001\r\u0001\r\u0001\r\u0001\r\u0001\r"+
		"\u0001\r\u0001\r\u0001\r\u0001\r\u0001\r\u0001\r\u0001\r\u0001\r\u0001"+
		"\r\u0001\r\u0001\r\u0001\r\u0005\r\u0146\b\r\n\r\f\r\u0149\t\r\u0003\r"+
		"\u014b\b\r\u0001\r\u0001\r\u0001\r\u0001\r\u0001\r\u0001\r\u0001\r\u0001"+
		"\r\u0001\r\u0001\r\u0001\r\u0001\r\u0001\r\u0001\r\u0001\r\u0001\r\u0001"+
		"\r\u0003\r\u015e\b\r\u0001\r\u0001\r\u0001\r\u0001\r\u0001\r\u0001\r\u0001"+
		"\r\u0001\r\u0001\r\u0001\r\u0001\r\u0001\r\u0001\r\u0001\r\u0001\r\u0001"+
		"\r\u0001\r\u0001\r\u0001\r\u0001\r\u0001\r\u0001\r\u0001\r\u0001\r\u0001"+
		"\r\u0001\r\u0001\r\u0001\r\u0001\r\u0001\r\u0001\r\u0001\r\u0001\r\u0001"+
		"\r\u0001\r\u0001\r\u0001\r\u0001\r\u0001\r\u0001\r\u0005\r\u0188\b\r\n"+
