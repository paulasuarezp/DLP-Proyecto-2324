...
public class GrammarParser extends Parser {
	...
	public static final int
		...
		BOOLEAN_CONSTANT=53, INT_CONSTANT=54, REAL_CONSTANT=55, IDENT=56, LINE_COMMENT=57, 
		MULTILINE_COMMENT=58, CHAR_CONSTANT=59, WHITESPACE=60;
	public static final int
		...
		RULE_param = 8, RULE_runCall = 9, RULE_sentence = 10, RULE_initFromLoop = 11, 
		RULE_expr = 12, RULE_type = 13;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "defTuple", "field", "vars", "varListDefinition", "varListIdents", 
			"featureBuilder", "featureDef", "param", "runCall", "sentence", "initFromLoop", 
			"expr", "type"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, "BOOLEAN_CONSTANT", "INT_CONSTANT", "REAL_CONSTANT", 
			"IDENT", "LINE_COMMENT", "MULTILINE_COMMENT", "CHAR_CONSTANT", "WHITESPACE"
		};
	}
	...
	public final FeatureDefContext featureDef() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 711568853578555392L) != 0) {
				{
				{
				setState(138);
	...
	public final RunCallContext runCall() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((_la) & ~0x3f) == 0 && ((1L << _la) & 711568852793696256L) != 0) {
				{
				setState(155);
	...
	public final InitFromLoopContext initFromLoop() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 711568852793696256L) != 0) {
				{
				{
				setState(261);
	...
	public static class ExprContext extends ParserRuleContext {
		...
		public TerminalNode BOOLEAN_CONSTANT() { return getToken(GrammarParser.BOOLEAN_CONSTANT, 0); }
		...
		try {
			...
			case 1:
				...
				((ExprContext)_localctx).BOOLEAN_CONSTANT = match(BOOLEAN_CONSTANT);
				 ((ExprContext)_localctx).ast =  new BooleanConstant(((ExprContext)_localctx).BOOLEAN_CONSTANT); 
				}
				break;
			case 2:
				{
		...
		try {
			...
			case T__48:
				...
				((TypeContext)_localctx).token = match(T__48);
				 ((TypeContext)_localctx).ast =  new BooleanType(); _localctx.ast.updatePositions(((TypeContext)_localctx).token);
				}
				break;
			case T__49:
				enterOuterAlt(_localctx, 2);
