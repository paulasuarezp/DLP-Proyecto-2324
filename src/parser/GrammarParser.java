...
public class GrammarParser extends Parser {
	...
	public static final int
		...
		RULE_param = 8, RULE_runCall = 9, RULE_sentence = 10, RULE_varListExpr = 11, 
		RULE_complexAssignment = 12, RULE_initFromLoop = 13, RULE_expr = 14, RULE_type = 15;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "defTuple", "field", "vars", "varListDefinition", "varListIdents", 
			"featureBuilder", "featureDef", "param", "runCall", "sentence", "varListExpr", 
			"complexAssignment", "initFromLoop", "expr", "type"
		};
	}
	...
	public final FeatureDefContext featureDef() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 175640497921466368L) != 0) {
				{
				{
				setState(142);
	...
	public static class SentenceContext extends ParserRuleContext {
		...
		public ComplexAssignmentContext complexAssignment;
		public Token token;
		public Token IDENT;
		public List<ExprContext> expr() {
			return getRuleContexts(ExprContext.class);
		...
		public ComplexAssignmentContext complexAssignment() {
			return getRuleContext(ComplexAssignmentContext.class,0);
		}
		public TerminalNode IDENT() { return getToken(GrammarParser.IDENT, 0); }
	...
	public final SentenceContext sentence() throws RecognitionException {
		...
		try {
			...
			case 6:
				...
				{
				setState(242);
				((SentenceContext)_localctx).complexAssignment = complexAssignment();
				setState(243);
				match(T__1);
				 ((SentenceContext)_localctx).ast =  ((SentenceContext)_localctx).complexAssignment.ast ; 
				}
				break;
			case 7:
	...
	public final VarListExprContext varListExpr() throws RecognitionException {
		...
		enterRule(_localctx, 22, RULE_varListExpr);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	@SuppressWarnings("CheckReturnValue")
	public static class ComplexAssignmentContext extends ParserRuleContext {
		public ComplexAssignment ast;
		public ExprContext left;
		public VarListExprContext right;
		public ExprContext expr() {
		...
		public ComplexAssignmentContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_complexAssignment; }
	}

	public final ComplexAssignmentContext complexAssignment() throws RecognitionException {
		ComplexAssignmentContext _localctx = new ComplexAssignmentContext(_ctx, getState());
		enterRule(_localctx, 24, RULE_complexAssignment);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(281);
			((ComplexAssignmentContext)_localctx).left = expr(0);
			setState(282);
			match(T__27);
			setState(283);
			((ComplexAssignmentContext)_localctx).right = varListExpr();
			 ((ComplexAssignmentContext)_localctx).ast =  new ComplexAssignment(((ComplexAssignmentContext)_localctx).left.ast, ((ComplexAssignmentContext)_localctx).right.list); 
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final InitFromLoopContext initFromLoop() throws RecognitionException {
		...
		enterRule(_localctx, 26, RULE_initFromLoop);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
