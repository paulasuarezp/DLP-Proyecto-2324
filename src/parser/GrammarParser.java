...
public class GrammarParser extends Parser {
	...
	public final FeatureDefContext featureDef() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 351280883388915712L) != 0) {
				{
				{
				setState(138);
	...
	public final RunCallContext runCall() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((_la) & ~0x3f) == 0 && ((1L << _la) & 351280882604056576L) != 0) {
				{
				setState(155);
	...
	public final InitFromLoopContext initFromLoop() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( ((_la) & ~0x3f) == 0 && ((1L << _la) & 351280882604056576L) != 0 );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						match(T__36);
						setState(317);
						((ExprContext)_localctx).e = ((ExprContext)_localctx).expr = expr(7);
						 ((ExprContext)_localctx).ast =  new PotenciaExpr(((ExprContext)_localctx).b.ast, ((ExprContext)_localctx).e.ast); 
						}
						break;
					case 2:
						{
					...
					case 7:
						...
						setState(346);
						((ExprContext)_localctx).operator = match(T__48);
						setState(347);
