...
public class GrammarParser extends Parser {
	...
	public static final int
		...
		RULE_varListIdents = 5, RULE_featureDef = 6, RULE_param = 7, RULE_runCall = 8, 
		RULE_sentence = 9, RULE_initFromLoop = 10, RULE_expr = 11, RULE_type = 12;
	...
	public final FeatureDefContext featureDef() throws RecognitionException {
		...
		enterRule(_localctx, 12, RULE_featureDef);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 351351183413616640L) != 0) {
				{
				{
				setState(132);
	...
	public final RunCallContext runCall() throws RecognitionException {
		...
		enterRule(_localctx, 16, RULE_runCall);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((_la) & ~0x3f) == 0 && ((1L << _la) & 351351182628757504L) != 0) {
				{
				setState(149);
	...
	public final InitFromLoopContext initFromLoop() throws RecognitionException {
		...
		enterRule(_localctx, 20, RULE_initFromLoop);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 351351182628757504L) != 0) {
				{
				{
				setState(268);
