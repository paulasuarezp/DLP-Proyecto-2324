...
public class ComparationExpr extends AbstractExpression  {
	...
	public ComparationExpr(Expression op1, String operator, Expression op2) {
		super();
	...
	public ComparationExpr(Object op1, Object operator, Object op2) {
		super();
    ...
    public String toString() {
        return "ComparationExpr{" + " op1=" + this.getOp1() + " operator=" + this.getOperator() + " op2=" + this.getOp2() + "}";
    }
