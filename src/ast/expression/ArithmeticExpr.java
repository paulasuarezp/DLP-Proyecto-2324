...
*/
public class ArithmeticExpr extends AbstractExpression  {
	...
	public ArithmeticExpr(Expression op1, String operator, Expression op2) {
		super();
	...
	public ArithmeticExpr(Object op1, Object operator, Object op2) {
		super();
    ...
    public String toString() {
        return "ArithmeticExpr{" + " op1=" + this.getOp1() + " operator=" + this.getOperator() + " op2=" + this.getOp2() + "}";
    }
